...
public class MainActivity extends AppCompatActivity {
    ...
    private void initBluetooth() {
                ...
                if (action.equals(BluetoothAdapter.ACTION_STATE_CHANGED)) {
                    ...
                    switch (bluetoothState) {
                        case BluetoothAdapter.STATE_ON:
                            if(user.getModalita() == User.MODALITA_SEGNALAZIONE || user.getModalita() == User.MODALITA_NORMALE
        ...
        if (datipassati != null && datipassati.getBoolean("AvviaTastoEmergenza",false))
            listenerBottoneEmergenza();
    ...
    public void listenerIP() {

        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setMessage("Non sono riuscito a trovare l'ip del server.\nPremere No per uscire Si per riprovare.").setPositiveButton("Si", dialogClickListener)
        ...
        public void onClick(DialogInterface dialog, int response) {
            ...
            switch (response) {
                ...
                case DialogInterface.BUTTON_NEGATIVE: {
                    Intent intent = new Intent(c, RegistrationTokenService.class);
                    startService(intent);
                    dialog.cancel();
                    finish();
                    break;
